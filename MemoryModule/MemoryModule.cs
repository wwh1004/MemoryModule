...
namespace MemoryModules {
	...
	public unsafe class MemoryModule {
		...
		private MemoryModule(MEMORYMODULE internalModule) {
		...
		public void FreeLibrary() {
			MemoryModuleC.MemoryFreeLibrary(InternalModule);
		}
		...
		public IntPtr GetProcAddress(string functionName) {
			return (IntPtr)MemoryModuleC.MemoryGetProcAddress(InternalModule, functionName);
		}
		...
		public int CallEntryPoint() {
			return MemoryModuleC.MemoryCallEntryPoint(InternalModule);
		}
	}
}
